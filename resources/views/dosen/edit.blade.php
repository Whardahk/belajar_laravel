			...
			<div class="card-body">
				...
				<form action="/dosen/update" method="post">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-4">
							<input type="number" class="form-control form-control-sm" name="umur" value="{{ $p->umur }}" required>
						</div>
					</div>
					<div class="row mb-3">
						<label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm" style="text-align: right;">Alamat</label>
						<div class="col-sm-8">
							<textarea class="form-control form-control-sm" name="alamat" required>{{ $p->alamat }}</textarea>
						</div>
					</div>
					<div class="row mb-3">
